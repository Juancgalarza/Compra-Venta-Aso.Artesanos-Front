<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"> <b><i class="fas fa-folder mr-2"></i>Ventas Mensuales</b> </h1>
            </div>
        </div>
    </div>
</div>
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-bordered dataTable text-center">
                                        ...
                                        <tfoot>
                                            ...
                                            <th id="subtotal-general" class="text-purple"></th>
                                            <th id="iva-general" class="text-purple"></th>
...
<script src="<?=BASE?>views/dist/js/scripts/ventasMensuales.js"></script>