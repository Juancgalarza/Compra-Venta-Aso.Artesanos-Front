<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"> <b><i class="fas fa-folder mr-2"></i>Productos Más Vendidos</b> </h1>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row mb-3 d-flex justify-content-center">
            ...
            <div class="col-6 col-md-4 col-lg-3 form-group">
                ...
                <select id="limite" class="form-control form-control-sm">
                    <option value="0">Seleccione un límite</option>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 text-center">
                        <div class="mt-3">
                            <div class="card card-purple shadow-lg">
                                <div class="card-header">
                                    <h5>Porcentaje de Productos</h5>
                                </div>
                                <div class="card-body">
                                    <div id="productos-porcentaje"></div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="<?=BASE?>views/dist/js/scripts/productosMasVendidos.js"></script>